...
VALUES (
  'Budget entreprise',
  'budget-entreprise',
  'Budget d''entreprise sur le plan comptable général : exercices, centres de coût, prévisionnel vs réalisé, journal d''audit — avec compte de résultat et bilan.',
  '💰',
  '/business/budget-entreprise',

...
VALUES (
  'Budget association',
  'budget-association',
  'Comptabilité associative (plan PCG loi 1901) : exercices budgétaires, sous-budgets fonctionnement/actions, prévisionnel vs réalisé, journal d''audit, pièces justificatives, reports de provisions.',
  '💶',
  '/business/budget-association',

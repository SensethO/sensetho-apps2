...
-- ============================================================
-- Favoris utilisateur (cross-browser, cross-device)
-- ============================================================
...
alter table public.user_app_favorites enable row level security;

create policy "users_own_favorites"
  on public.user_app_favorites for all
  using (auth.uid() = user_id)
  with check (auth.uid() = user_id);

create index if not exists idx_user_app_favorites_user_id
  on public.user_app_favorites(user_id);

...
// ─── Données ISO 26000 — domaines prioritaires ────────────────────────────────
...
const DOMAINS: Domain[] = [
  ...
  },
  {
    ...
    rationale: "Premier enjeu social et légal. La santé et la sécurité au travail impactent chaque collaborateur quotidiennement — c'est la responsabilité minimale attendue de tout employeur.",
  ...
  },
  {
    ...
    rationale: "Pression réglementaire croissante (CSRD, taxonomie verte, loi Énergie-Climat). Mesurer son empreinte carbone est désormais incontournable — c'est aussi un levier d'économies concrètes.",
  ...
  },
  {
    ...
    rationale: "Obligation légale (Loi Sapin 2 pour les organisations ≥500 salariés). Le risque réputationnel et pénal en cas de corruption est majeur pour toute organisation, quelle que soit sa taille.",
    focusActionIndices: [0, 1, 2, 3],
    actions: [
  ...
  },
  {
    ...
    qcNom: 'Relations et conditions de travail', qcIcone: '👷',
    rationale: "Des conditions d'emploi équitables sont le premier levier d'attractivité et de fidélisation des talents — un enjeu critique dans le contexte de tension sur le marché du travail.",
  ...
  },
  {
    ...
    qcNom: 'Relations et conditions de travail', qcIcone: '👷',
    rationale: "La formation est un droit pour chaque salarié et un investissement à ROI prouvé. La CSRD impose désormais de mesurer et de communiquer cet engagement.",
    focusActionIndices: [0, 1, 2, 5],
    actions: [
  ...
  },
  {
    ...
    qcNom: 'Relations et conditions de travail', qcIcone: '👷',
    rationale: "L'Index Égalité Professionnelle est obligatoire dès 50 salariés. L'égalité femmes/hommes est aussi un facteur de performance mesurable et une attente forte des parties prenantes.",
    focusActionIndices: [0, 1, 2, 3],
    actions: [
  ...
  },
  {
    ...
    qcNom: 'Environnement', qcIcone: '🌱',
    rationale: "Réduire les déchets et les émissions polluantes génère souvent des économies immédiates. C'est aussi le domaine environnemental le plus visible pour les riverains et les collectivités.",
  ...
  },
  {
    ...
    actions: [
      ...
      "Mettre en œuvre un plan d'efficacité énergétique (isolation, équipements, process)",
  ...
  },
  {
    ...
    rationale: "La loi française sur le devoir de vigilance s'applique aux grandes entreprises et s'étend progressivement via la CSDDD européenne. Anticiper maintenant, c'est éviter une mise en conformité en urgence.",
    focusActionIndices: [0, 1, 2, 4],
    actions: [
      ...
      "Mettre en œuvre des procédures d'évaluation et d'audit fournisseurs sur les droits humains",
  ...
  },
  {
    ...
    rationale: "La conformité RGPD est une obligation légale depuis 2018. La protection des données clients est aussi devenue un avantage concurrentiel fort dans un contexte de méfiance croissante.",
  ...
  },
  {
    ...
    rationale: "L'ancrage territorial est un avantage compétitif et une attente forte des parties prenantes locales. Il différencie durablement les organisations responsables de leurs concurrentes.",
    focusActionIndices: [0, 1, 2, 3],
    actions: [

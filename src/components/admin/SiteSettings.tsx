...
const CATEGORIES: { key: CategoryKey; label: string; emoji: string }[] = [
  ...
  { key: 'features', label: 'La démarche', emoji: '👁️' },
  { key: 'apps_section', label: 'Section Apps', emoji: '📦' },
  { key: 'rse', label: 'Bloc Miroir', emoji: '🪞' },
...
const SETTINGS_META: SettingMeta[] = [
  ...
  // features (les 4 étapes de la démarche)
  { key: 'feature_1_title', label: 'Étape 1 — Titre', category: 'features' },
  { key: 'feature_1_desc', label: 'Étape 1 — Description', category: 'features', multiline: true },
  { key: 'feature_2_title', label: 'Étape 2 — Titre', category: 'features' },
  { key: 'feature_2_desc', label: 'Étape 2 — Description', category: 'features', multiline: true },
  { key: 'feature_3_title', label: 'Étape 3 — Titre', category: 'features' },
  { key: 'feature_3_desc', label: 'Étape 3 — Description', category: 'features', multiline: true },
  { key: 'feature_4_title', label: 'Étape 4 — Titre', category: 'features' },
  { key: 'feature_4_desc', label: 'Étape 4 — Description', category: 'features', multiline: true },
  ...
  // rse (bloc « Notre propre miroir » — l'engagement Sens'ethO)
  { key: 'rse_badge', label: 'Badge du bloc', description: "Texte du badge d'accroche", category: 'rse' },
  { key: 'rse_title', label: 'Titre du bloc', category: 'rse' },
  { key: 'rse_desc', label: 'Description du bloc', category: 'rse', multiline: true },
...
const SETTINGS_DEFAULTS: Record<string, string> = {
  ...
  hero_subtitle:
    "Une démarche ne commence pas par un référentiel : elle commence par un regard. Observez ce que votre organisation fait vraiment, formulez sa raison d'être, choisissez vos engagements — puis outillez-les, au moment où il le faut.",
  ...
  rse_desc:
    "« Aider les organisations à se voir agir et à retrouver du sens » — c'est notre raison d'être, et elle nous engage : gouvernance partagée, lucrativité encadrée, et 30 % des bénéfices consacrés à l'équité des chances, pour les enfants et adolescents de l'ASE et ceux vivant sous le seuil de pauvreté.",

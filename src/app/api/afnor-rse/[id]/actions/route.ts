...
async function canWrite(userId: string, diagnosticId: string): Promise<boolean> {
  ...
  const { data } = await admin
    .from('afnor_diagnostics').select('user_id').eq('id', diagnosticId).single()
  return data?.user_id === userId
}

/** GET /api/afnor-rse/[id]/actions?critere_id=xxx */
...
/** POST /api/afnor-rse/[id]/actions — créer une action */
...
/** PATCH /api/afnor-rse/[id]/actions?action_id=xxx */
...
/** DELETE /api/afnor-rse/[id]/actions?action_id=xxx */

...
/** GET /api/afnor-rse/[id] — détail complet */
export async function GET(
  ...
  try {
    ...
    const [diagRes, repRes, actRes] = await Promise.all([
      admin.from('afnor_diagnostics').select('*').eq('id', params.id).single(),
...
/** PATCH /api/afnor-rse/[id] — mise à jour score_global et statut */

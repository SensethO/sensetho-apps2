...
export async function GET(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    const admin = createAdminClient()
    let query = admin.from('sapin2_actions').select('*').eq('diagnostic_id', params.id).order('created_at') as any
...
/** POST /api/sapin2/[id]/actions — créer une action */
...
/** PATCH /api/sapin2/[id]/actions?action_id=xxx */
...
/** DELETE /api/sapin2/[id]/actions?action_id=xxx */

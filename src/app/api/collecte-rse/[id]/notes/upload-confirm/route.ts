...
/**
 * POST /api/collecte-rse/[id]/notes/upload-confirm
 * Body: { actionKey, attachmentId, spItemId, name, mime, size, annexeIndex }
 * Stocke les métadonnées dans collecte_rse_notes — le fichier est dans SharePoint.
 */
export async function POST(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    // Le fichier est dans SharePoint ; on retourne les métadonnées pour GuidedActionNotePanel

...
/** GET /api/collecte-rse/[id] — détail complet */
export async function GET(
  ...
  try {
    ...
    const [diagRes, repRes, actRes] = await Promise.all([
      admin.from('collecte_rse_diagnostics').select('*').eq('id', params.id).single(),
...
/** PATCH /api/collecte-rse/[id] — mise à jour score_global et statut */

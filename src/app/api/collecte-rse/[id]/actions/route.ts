...
async function canWrite(userId: string, diagnosticId: string): Promise<boolean> {
  ...
  const { data } = await admin
    .from('collecte_rse_diagnostics').select('user_id').eq('id', diagnosticId).single()
  return data?.user_id === userId
}

/** GET /api/collecte-rse/[id]/actions?critere_id=xxx */
...
/** POST /api/collecte-rse/[id]/actions — créer une action */
...
/** PATCH /api/collecte-rse/[id]/actions?action_id=xxx */
...
/** DELETE /api/collecte-rse/[id]/actions?action_id=xxx */

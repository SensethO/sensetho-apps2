...
/** GET /api/ecgt/[id] — détail complet */
export async function GET(
  ...
  try {
    ...
    const [diagRes, repRes, actRes] = await Promise.all([
      admin.from('ecgt_diagnostics').select('*').eq('id', params.id).single(),
...
/** PATCH /api/ecgt/[id] — mise à jour score_global et statut */

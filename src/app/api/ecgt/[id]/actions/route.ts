...
/** GET /api/ecgt/[id]/actions?critere_id=xxx */
export async function GET(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    let query = admin.from('ecgt_actions').select('*').eq('diagnostic_id', params.id).order('created_at') as any
...
/** POST /api/ecgt/[id]/actions — créer une action */
...
/** PATCH /api/ecgt/[id]/actions?action_id=xxx */
...
/** DELETE /api/ecgt/[id]/actions?action_id=xxx */

...
/** GET /api/label-nr/[id] — détail complet */
export async function GET(
  ...
  try {
    ...
    const [diagRes, repRes, actRes] = await Promise.all([
      admin.from('label_nr_diagnostics').select('*').eq('id', params.id).single(),
...
/** PATCH /api/label-nr/[id] — mise à jour score_global et statut */

...
async function canWrite(userId: string, diagnosticId: string): Promise<boolean> {
  ...
  const { data } = await admin
    .from('label_nr_diagnostics').select('user_id').eq('id', diagnosticId).single()
  return data?.user_id === userId
}

/** GET /api/label-nr/[id]/actions?critere_id=xxx */
...
/** POST /api/label-nr/[id]/actions — créer une action */
...
/** PATCH /api/label-nr/[id]/actions?action_id=xxx */
...
/** DELETE /api/label-nr/[id]/actions?action_id=xxx */

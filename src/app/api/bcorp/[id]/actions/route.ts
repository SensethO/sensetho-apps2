...
async function canWrite(userId: string, diagnosticId: string): Promise<boolean> {
  ...
  const { data } = await admin
    .from('bcorp_diagnostics').select('user_id').eq('id', diagnosticId).single()
  return data?.user_id === userId
}

/** GET /api/bcorp/[id]/actions?critere_id=xxx */
...
/** POST /api/bcorp/[id]/actions — créer une action */
...
/** PATCH /api/bcorp/[id]/actions?action_id=xxx */
...
/** DELETE /api/bcorp/[id]/actions?action_id=xxx */

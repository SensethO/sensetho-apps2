...
const APP_SLUG = 'iso53001'
const TABLE = 'iso53001_diagnostics'
...
/** GET /api/iso53001/[id]/actions?critere_id=xxx */
export async function GET(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    let query = admin.from('iso53001_actions').select('*').eq('diagnostic_id', params.id).order('created_at') as any
...
/** POST /api/iso53001/[id]/actions — créer une action */
...
/** PATCH /api/iso53001/[id]/actions?action_id=xxx */
...
/** DELETE /api/iso53001/[id]/actions?action_id=xxx */

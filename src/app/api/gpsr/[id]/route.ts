...
/** GET /api/gpsr/[id] — détail complet */
export async function GET(
  ...
  try {
    ...
    const [diagRes, repRes, actRes] = await Promise.all([
      admin.from('gpsr_diagnostics').select('*').eq('id', params.id).single(),
...
/** PATCH /api/gpsr/[id] — mise à jour score_global et statut */

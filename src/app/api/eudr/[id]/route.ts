...
/** GET /api/eudr/[id] — détail complet */
export async function GET(
  ...
  try {
    ...
    const [diagRes, repRes, actRes] = await Promise.all([
      admin.from('eudr_diagnostics').select('*').eq('id', params.id).single(),
...
/** PATCH /api/eudr/[id] — mise à jour score_global et statut */

...
async function canWrite(userId: string, diagnosticId: string): Promise<boolean> {
  ...
  const { data } = await admin
    .from('eudr_diagnostics').select('user_id').eq('id', diagnosticId).single()
  return data?.user_id === userId
}

/** GET /api/eudr/[id]/actions?critere_id=xxx */
...
/** POST /api/eudr/[id]/actions — créer une action */
...
/** PATCH /api/eudr/[id]/actions?action_id=xxx */
...
/** DELETE /api/eudr/[id]/actions?action_id=xxx */

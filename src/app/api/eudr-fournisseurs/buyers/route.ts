...
/** GET /api/eudr-fournisseurs/buyers?org_id=xxx — liste des acheteurs de l'org */
...
/** POST /api/eudr-fournisseurs/buyers — créer un acheteur */
...
/** PATCH /api/eudr-fournisseurs/buyers?id=xxx — modifier un acheteur */
...
/** DELETE /api/eudr-fournisseurs/buyers?id=xxx — supprimer un acheteur */

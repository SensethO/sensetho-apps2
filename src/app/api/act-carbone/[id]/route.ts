...
/** GET /api/act-carbone/[id] — détail complet */
export async function GET(
  ...
  try {
    ...
    const [diagRes, repRes, actRes] = await Promise.all([
      admin.from('act_carbone_diagnostics').select('*').eq('id', params.id).single(),
...
/** PATCH /api/act-carbone/[id] — mise à jour score_global et statut */

...
/** GET /api/iso45001/[id] — détail complet */
export async function GET(
  ...
  try {
    ...
    const [diagRes, repRes, actRes] = await Promise.all([
      admin.from('iso45001_diagnostics').select('*').eq('id', params.id).single(),
...
/** PATCH /api/iso45001/[id] — mise à jour score_global et statut */

...
/** GET /api/afaq26000/[id] — détail complet */
export async function GET(
  ...
  try {
    ...
    const [diagRes, repRes, actRes] = await Promise.all([
      admin.from('afaq26000_diagnostics').select('*').eq('id', params.id).single(),
...
/** PATCH /api/afaq26000/[id] — mise à jour score_global et statut */

...
/** GET /api/strategie-partagee/shares?org_id=xxx — liste des partages du dossier de l'org */
...
/** POST /api/strategie-partagee/shares — body { org_id, email, permission } */
...
/** DELETE /api/strategie-partagee/shares?shareId=xxx&org_id=xxx */

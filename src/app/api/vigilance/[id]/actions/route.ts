...
async function canWrite(userId: string, diagnosticId: string): Promise<boolean> {
  ...
  const { data } = await admin
    .from('vigilance_diagnostics').select('user_id').eq('id', diagnosticId).single()
  return data?.user_id === userId
}

/** GET /api/vigilance/[id]/actions?critere_id=xxx */
...
/** POST /api/vigilance/[id]/actions — créer une action */
...
/** PATCH /api/vigilance/[id]/actions?action_id=xxx */
...
/** DELETE /api/vigilance/[id]/actions?action_id=xxx */
